                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>${message(code: 'department.label', default: 'Department')}</th>
                    ...
                    <g:each in="${deliveryScoreInstanceList}" status="i" var="deliveryScoreInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>
                            	<g:radio name="id" value="${deliveryScoreInstance.id}"/>
                            </td>
                            
                            <td>${deliveryScoreInstance.unloading.department.name }</td>
                            ...
                            <td><g:formatDate date="${deliveryScoreInstance.unloading.unloadingTime}" /></td>
