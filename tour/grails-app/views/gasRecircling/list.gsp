        ...
        <div class="body">
            ...
            <div class="list">
                <table>
                    ...
                    <tbody>
                    <g:each in="${gasRecirclingInstanceList}" status="i" var="gasRecirclingInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        
                            <td><g:link action="summaryShow" id="${gasRecirclingInstance.id}">${fieldValue(bean: gasRecirclingInstance, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: gasRecirclingInstance, field: "department.name")}</td>
                        
                            <td>${fieldValue(bean: gasRecirclingInstance, field: "type.title")}</td>

                            <td><g:formatDate date="${gasRecirclingInstance.time}" /></td>
                        </tr>
                    </g:each>
                    </tbody>
                </table>
            ...
            <div class="paginateButtons">
                <g:paginate total="${gasRecirclingInstanceTotal}" params="${params }"/>
            </div>
        </div>
    </body>
</html>
