        ...
        <div class="body">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.patrolType.label" default="巡检方式" /></td>
                            
                            <td valign="top" class="value">${userInstance?.patrolType?.title}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.userDepartment.label" default="站权限" /></td>
                            
                            <td valign="top" class="value">
                            	<g:each in="${userDepartments }" var="d">
                            		${d.department.name } &nbsp;
                            	</g:each>
                            </td>
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <span class="button"><g:actionSubmit class="resetPsw" action="resetPsw" value="${message(code: 'user.button.resetPsw.label', default: 'Reset Password')}" onclick="return confirm('${message(code: 'user.button.resetPsw.confirm.message', default: 'Are you sure?')}');" /></span>
                </g:form>
            </div>
        </div>
    </body>
