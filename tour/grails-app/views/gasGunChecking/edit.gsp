    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${gasGunCheckingInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: gasGunCheckingInstance, field: 'gun', 'errors')}">
                                    <g:select name="gun.id" from="${com.surelution.tour.GasGun.list()}" optionKey="id" value="${gasGunCheckingInstance?.gun?.id}"  />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="user"><g:message code="gasGunChecking.user.label" default="User" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: gasGunCheckingInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${com.surelution.tour.User.list()}" optionKey="id" value="${gasGunCheckingInstance?.user?.id}"  />
                                </td>
                            </tr>
