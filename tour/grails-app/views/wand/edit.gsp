    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${wandInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: wandInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${com.surelution.tour.User.list()}" optionKey="id" optionValue="username" optionValue="username" value="${wandInstance?.user?.id}"/>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: wandInstance, field: 'description', 'errors')}">
                                    <g:textArea name="description" value="${wandInstance?.description}" />
                                </td>
                            </tr>
