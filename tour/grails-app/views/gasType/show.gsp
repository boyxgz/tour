                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: gasTypeInstance, field: "id")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="gasType.title.label" default="Title" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: gasTypeInstance, field: "title")}</td>
