                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="title" title="${message(code: 'gasType.title.label', default: 'Title')}" />
                    ...
                    <g:each in="${gasTypeInstanceList}" status="i" var="gasTypeInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${gasTypeInstance.id}">${fieldValue(bean: gasTypeInstance, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: gasTypeInstance, field: "title")}</td>
