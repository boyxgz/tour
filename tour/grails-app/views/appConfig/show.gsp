            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="appConfig.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="appConfig.key.label" default="Key" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: appConfigInstance, field: "key")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="appConfig.value.label" default="Value" /></td>
