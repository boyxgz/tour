...
<%@ page import="com.surelution.tour.LeaveType" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="leaveType.name.label" default="Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: leaveTypeInstance, field: "name")}</td>
