            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="branch.address.label" default="Address" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: branchInstance, field: "address")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="branch.tel.label" default="Tel" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: branchInstance, field: "tel")}</td>
