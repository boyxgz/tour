        ...
        if (appConfigInstance) {
            if (params.version) {
                ...
                if (appConfigInstance.version > version) {
                    ...
                    appConfigInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'appConfig.label', default: 'AppConfig')] as Object[], "Another user has updated this AppConfig while you were editing")
    ...
    def delete = {
        ...
        if (appConfigInstance) {
            try {
                ...
                flash.message = "${message(code: 'default.deleted.message', args: [message(code: 'appConfig.label', default: 'AppConfig'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${message(code: 'default.not.deleted.message', args: [message(code: 'appConfig.label', default: 'AppConfig'), params.id])}"
